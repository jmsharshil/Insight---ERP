...
export const ROLES: Record<RoleId, RoleDefinition> = {
  super_admin: {
    ...
    modules: ["crm","students","courses_batches","timetable","attendance","fees","exams","results","faculty","leave","chat","inventory","notifications","audit_logs","payroll","settings","users"],
  ...
  branch_manager: {
    ...
    modules: ["crm","students","courses_batches","timetable","attendance","fees","exams","results","faculty","payroll","leave","chat","notifications","audit_logs","settings"],
  ...
  admin_senior_executive: {
    ...
    modules: ["crm","students","courses_batches","timetable","attendance","fees","exams","results","leave","chat","notifications","payroll","settings"],
    canDelete: false, canExport: true,
  },
  admin_executive: {
    ...
    modules: ["students","attendance","courses_batches","timetable","leave","payroll","notifications","settings"],
  ...
  front_desk: {
    ...
    modules: ["crm","attendance","leave","payroll","notifications","settings"],
    canDelete: false, canExport: false,
  },
  counsellor: {
    ...
    modules: ["crm","students","attendance","leave","payroll","notifications","settings"],
    canDelete: false, canExport: false,
  },
  tele_caller: {
  ...
  parents: {
    ...
    modules: ["timetable","attendance","courses_batches","fees","exams","leave","chat","notifications","settings"],
    canDelete: false, canExport: false,
  },
  faculty: {
    id: "faculty", label: "Faculty", description: "Teaching staff member",
    color: "bg-amber-100", textColor: "text-amber-800",
    modules: ["timetable","attendance","exams","leave","chat","notifications","payroll","settings"],
    canDelete: false, canExport: false,
  },
  exam_supervisor: {
