...
export const ROLES: Record<RoleId, RoleDefinition> = {
  super_admin: {
    ...
    modules: ["dashboard","crm","students","timetable","attendance","fees","exams","exam_supervision","faculty","leave","chat","notifications","audit_logs","reports","payroll","settings","users"],
  ...
  branch_manager: {
    ...
    modules: ["dashboard","crm","students","timetable","attendance","fees","exams","leave","chat","notifications","audit_logs","reports"],
  ...
  admin_senior_executive: {
    ...
    modules: ["dashboard","crm","students","timetable","attendance","fees","exams","leave","chat","notifications","reports"],
    canDelete: false, canExport: true,
  },
  admin_executive: {
    ...
    modules: ["dashboard","students","attendance","timetable"],
  ...
  student: {
    ...
    modules: ["dashboard","attendance","timetable","exams","fees","chat","notifications"],
    canDelete: false, canExport: false,
  },
  parents: {
