...
export const ROLES: Record<RoleId, RoleDefinition> = {
  super_admin: {
    ...
    modules: ["dashboard","crm","students","courses_batches","timetable","attendance","fees","exams","results","faculty","leave","chat","inventory","notifications","audit_logs","payroll","settings","users"],
  ...
  branch_manager: {
    ...
    modules: ["dashboard","crm","students","courses_batches","timetable","attendance","fees","exams","results","faculty","payroll","leave","chat","notifications","audit_logs","settings"],
  ...
  admin_senior_executive: {
    ...
    modules: ["dashboard","crm","students","courses_batches","timetable","attendance","fees","exams","results","leave","chat","notifications","payroll","settings"],
    canDelete: false, canExport: true,
  },
  admin_executive: {
    ...
    modules: ["dashboard","students","attendance","courses_batches","timetable","leave","payroll","notifications","settings"],
  ...
  front_desk: {
    ...
    modules: ["dashboard","crm","attendance","leave","payroll","notifications","settings"],
    canDelete: false, canExport: false,
  },
  counsellor: {
    ...
    modules: ["dashboard","crm","students","attendance","leave","payroll","notifications","settings"],
    canDelete: false, canExport: false,
  },
  tele_caller: {
