...
export const ROLES: Record<RoleId, RoleDefinition> = {
  ...
  front_desk: {
    ...
    modules: ["crm","attendance","payroll","notifications","settings"],
    canDelete: false, canExport: false,
  },
  counsellor: {
    ...
    modules: ["crm","students","attendance","payroll","notifications","settings"],
    canDelete: false, canExport: false,
  },
  tele_caller: {
  ...
  accountant: {
    ...
    modules: ["attendance","fees","payroll","notifications","settings"],
    canDelete: false, canExport: true,
  },
  security: {
