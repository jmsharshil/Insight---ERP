...
export const API = {
  ...
  ATTENDANCE: {
    ...
    HISTORY: "/api/v1/attendance/",
    FACULTY: "/api/v1/attendance/employee/",
    FACULTY_DETAIL: (id: string) => `/api/v1/attendance/employee/${id}/`,
  ...
  PAYROLL: {
    ...
    PAYSLIP_DETAIL: (runId: string, slipId: string) =>
      `/api/v1/payroll/${runId}/payslips/${slipId}/`,
