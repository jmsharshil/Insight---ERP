...
export default function AdminExecDashboard() {
  const [data, setData] = useState<AdminExecData | null>(null);
  ...
  if (!data || !data.kpis) {
    return (
      <DashboardLayout pageTitle="Admin Executive Dashboard" stats={[]}>
  ...
  const getNumberStr = (val: number | string | undefined) => {
  ...
  return (
    <DashboardLayout pageTitle="Admin Executive Dashboard" stats={stats}>
