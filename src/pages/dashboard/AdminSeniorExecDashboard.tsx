...
export default function AdminSeniorExecDashboard() {
  const [data, setData] = useState<AdminSeniorExecData | null>(null);
  ...
  if (!data || !data.kpis) {
    return (
      <DashboardLayout pageTitle="Admin Sr. Executive Dashboard" stats={[]}>
  ...
  return (
    <DashboardLayout pageTitle="Admin Sr. Executive Dashboard" stats={stats}>
