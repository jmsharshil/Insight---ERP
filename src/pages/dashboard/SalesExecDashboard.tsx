...
export default function SalesExecDashboard() {
  const [data, setData] = useState<SalesExecData | null>(null);
  ...
  if (!data || !data.kpis) {
    return (
      <DashboardLayout pageTitle="Sales Executive Dashboard" stats={[]}>
  ...
  return (
    <DashboardLayout pageTitle="Sales Executive Dashboard" stats={stats}>
